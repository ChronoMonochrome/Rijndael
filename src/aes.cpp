...
static BYTE PowTab[256];        //     
static BYTE LogTab[256];        //   (    )
static BYTE SubBytesTab[256];    //    SubBytes
static BYTE    InvSubBytesTab[256];//    SubBytes

static BYTE MixCo[4] = {0x03, 0x01, 0x01, 0x02};    //    
static BYTE InvMixCo[4] = {0x0B, 0x0D, 0x09, 0x0E};    // MixColumn  InvMixColumn
